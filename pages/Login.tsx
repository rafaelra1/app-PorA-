                    ...
                    <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-8 md:p-10 border border-white/20">
                        ...
                        <div className="space-y-3">
                            ...
                            <button
                                ...
                                disabled={isLoading}
                                className="w-full h-12 bg-black hover:bg-gray-900 rounded-xl font-bold text-white transition-all disabled:opacity-50 flex items-center justify-center gap-3"
                            >
