...
import { NAV_ITEMS, DEMO_USER } from '../constants';
      ...
      <div>
        <div className="flex items-center gap-3 mb-10 px-2">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-xs text-text-muted dark:text-gray-400 mt-1 font-medium tracking-wide uppercase">{DEMO_USER.role}</span>
          </div>
        </div>
