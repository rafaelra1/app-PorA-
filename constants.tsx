...
export const MODAL_TYPE_LABELS: Record<DocumentType, { label: string; icon: string }> = {
  ...
  train: { label: 'Trem', icon: 'train' },
  bus: { label: 'Ônibus', icon: 'directions_bus' },
  transfer: { label: 'Transfer', icon: 'airport_shuttle' },
  ferry: { label: 'Ferry', icon: 'directions_boat' },
...
export const BRAZILIAN_HOLIDAYS = [
  ...
  { date: '2025-03-04', name: 'Carnaval', type: 'facultativo' },
  { date: '2025-03-05', name: 'Quarta-Feira de Cinzas', type: 'facultativo' },
  { date: '2025-04-18', name: 'Paixão de Cristo', type: 'nacional' },
  { date: '2025-04-21', name: 'Tiradentes', type: 'nacional' },
  { date: '2025-05-01', name: 'Dia Mundial do Trabalho', type: 'nacional' },
  { date: '2025-06-19', name: 'Corpus Christi', type: 'facultativo' },
  { date: '2025-09-07', name: 'Independência do Brasil', type: 'nacional' },
  { date: '2025-10-12', name: 'Nossa Senhora Aparecida', type: 'nacional' },
  { date: '2025-10-28', name: 'Dia do Servidor Público', type: 'facultativo' },
  { date: '2025-11-02', name: 'Finados', type: 'nacional' },
  { date: '2025-11-15', name: 'Proclamação da República', type: 'nacional' },
  { date: '2025-11-20', name: 'Dia da Consciência Negra', type: 'nacional' },
  { date: '2025-12-24', name: 'Véspera de Natal', type: 'facultativo' },
  { date: '2025-12-25', name: 'Natal', type: 'nacional' },
  { date: '2025-12-31', name: 'Véspera de Ano Novo', type: 'facultativo' },

  // Feriados 2026 - Conforme Portaria MGI nº 11.460/2025
  ...
  { date: '2026-04-20', name: 'Ponto Facultativo', type: 'facultativo' },
  ...
  { date: '2026-06-05', name: 'Ponto Facultativo', type: 'facultativo' },
  ...
  { date: '2026-12-24', name: 'Véspera de Natal', type: 'facultativo' },
  { date: '2026-12-25', name: 'Natal', type: 'nacional' },
  { date: '2026-12-31', name: 'Véspera de Ano Novo', type: 'facultativo' },
];
